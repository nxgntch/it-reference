...
These are tools FOR developers working ON nxgntch. For skills offered BY nxgntch, see [`SKILLS_INVENTORY.md`](SKILLS_INVENTORY.md).
...
### Agents Using Development Skills
...
2. Add entry to this DEVELOPMENT_SKILLS_INVENTORY.md table
...
2. Update this DEVELOPMENT_SKILLS_INVENTORY.md entry
...
## Comparison: Platform vs. Development Skills

| Aspect | Platform Skills | Development Skills |
|--------|---|---|
| **What they are** | Services offered BY nxgntch | Tools used BY developers TO BUILD nxgntch |
| **Location** | `.claude/skills/` | `skills/` |
| **Documentation** | [SKILLS_INVENTORY.md](SKILLS_INVENTORY.md) | [DEVELOPMENT_SKILLS_INVENTORY.md](DEVELOPMENT_SKILLS_INVENTORY.md) (this file) |
| **Audience** | End users of nxgntch | nxgntch team members |
| **Examples** | gpt-taste, docOptimizer, costAnalyzer | codeReview, planning, docUpdater |
| **Configuration** | [config/agents.yaml](../config/agents.yaml) | [.claude-plugin/agents/README.md](../.claude-plugin/agents/README.md) |
| **Count** | 12 | 22 |

**Navigation:**
- **Looking for platform skills (what nxgntch does)?** → See [SKILLS_INVENTORY.md](SKILLS_INVENTORY.md)
- **Looking for development skills (how to build nxgntch)?** → See [DEVELOPMENT_SKILLS_INVENTORY.md](DEVELOPMENT_SKILLS_INVENTORY.md) (this file)

---

## See Also

- **Platform Skills**: [SKILLS_INVENTORY.md](SKILLS_INVENTORY.md) (what nxgntch offers)
...
**Total development skills**: 22  
**Status**: Complete for Phase 5.1 (Development Skills Consolidation)
